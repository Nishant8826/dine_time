            ...
            <ScrollView contentContainerStyle={{ height: "100%" }}>
                <View className="m-2 flex justify-center items-center">
                    ...
                    <View className="w-5/6">
                        ...
                        <View>
                            <TouchableOpacity onPress={() => router.push('/signup')} className="flex flex-row my-5 p-2 justify-center items-center">
                                <Text className="text-white font-semibold">New user?{" "}</Text>
                                <Text className="font-semibold underline text-base text-[#f49b33]">Sign up</Text>
                            </TouchableOpacity>
